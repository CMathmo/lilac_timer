...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pros_clock_vlayout = QtWidgets.QVBoxLayout()
        self.pros_clock_vlayout.setObjectName("pros_clock_vlayout")
        self.pros_hlayout.addLayout(self.pros_clock_vlayout)
        ...
        self.mid_vlayout.addWidget(self.turn_name)
        ...
        self.cons_clock_vlayout = QtWidgets.QVBoxLayout()
        self.cons_clock_vlayout.setObjectName("cons_clock_vlayout")
        self.cons_hlayout.addLayout(self.cons_clock_vlayout)
